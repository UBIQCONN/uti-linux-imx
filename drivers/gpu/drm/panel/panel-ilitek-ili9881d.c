...
static const struct ili9881d_instr yb_tg7201280s03a_init[] = {
	...
	ILI9881D_COMMAND_INSTR(0x06,0x0A),
	...
	ILI9881D_COMMAND_INSTR(0x0F,0x1D),
	ILI9881D_COMMAND_INSTR(0x10,0x1D),
	...
	ILI9881D_COMMAND_INSTR(0x20,0x06),
	ILI9881D_COMMAND_INSTR(0x21,0x02),
	...
	ILI9881D_COMMAND_INSTR(0x5F,0x01),
	ILI9881D_COMMAND_INSTR(0x60,0x00),
	ILI9881D_COMMAND_INSTR(0x61,0x15),
	ILI9881D_COMMAND_INSTR(0x62,0x14),
	ILI9881D_COMMAND_INSTR(0x63,0x0E),
	ILI9881D_COMMAND_INSTR(0x64,0x0F),
	ILI9881D_COMMAND_INSTR(0x65,0x0C),
	ILI9881D_COMMAND_INSTR(0x66,0x0D),
	ILI9881D_COMMAND_INSTR(0x67,0x06),
	ILI9881D_COMMAND_INSTR(0x68,0x02),
	ILI9881D_COMMAND_INSTR(0x69,0x07),
	...
	ILI9881D_COMMAND_INSTR(0x75,0x01),
	ILI9881D_COMMAND_INSTR(0x76,0x00),
	ILI9881D_COMMAND_INSTR(0x77,0x14),
	ILI9881D_COMMAND_INSTR(0x78,0x15),
	ILI9881D_COMMAND_INSTR(0x79,0x0E),
	ILI9881D_COMMAND_INSTR(0x7A,0x0F),
	ILI9881D_COMMAND_INSTR(0x7B,0x0C),
	ILI9881D_COMMAND_INSTR(0x7C,0x0D),
	ILI9881D_COMMAND_INSTR(0x7D,0x06),
	ILI9881D_COMMAND_INSTR(0x7E,0x02),
	ILI9881D_COMMAND_INSTR(0x7F,0x07),
	...
	ILI9881D_COMMAND_INSTR(0x39,0x00),
	ILI9881D_COMMAND_INSTR(0x6C,0x15),
	ILI9881D_COMMAND_INSTR(0x6E,0x2B),
	ILI9881D_COMMAND_INSTR(0x6F,0x33),
	ILI9881D_COMMAND_INSTR(0x8D,0x18),
	ILI9881D_COMMAND_INSTR(0x87,0xBA),
	ILI9881D_COMMAND_INSTR(0x26,0x76),
	ILI9881D_COMMAND_INSTR(0xB2,0xD1),
	ILI9881D_COMMAND_INSTR(0xB5,0x06),
	ILI9881D_COMMAND_INSTR(0x3A,0x24),
	ILI9881D_COMMAND_INSTR(0x35,0x1F),
	ILI9881D_COMMAND_INSTR(0x33,0x14),
	ILI9881D_COMMAND_INSTR(0x3B,0x98),
	ILI9881D_SWITCH_PAGE_INSTR(1),
	ILI9881D_COMMAND_INSTR(0x22,0x0A),
	ILI9881D_COMMAND_INSTR(0x31,0x00),
	ILI9881D_COMMAND_INSTR(0x40,0x33),
	ILI9881D_COMMAND_INSTR(0x53,0x8B),	//A2
	ILI9881D_COMMAND_INSTR(0x55,0x92),
	ILI9881D_COMMAND_INSTR(0x50,0x96),
	ILI9881D_COMMAND_INSTR(0x51,0x96),
	ILI9881D_COMMAND_INSTR(0x60,0x22),
	ILI9881D_COMMAND_INSTR(0x61,0x00),
	ILI9881D_COMMAND_INSTR(0x62,0x19),
	ILI9881D_COMMAND_INSTR(0x63,0x00),
	ILI9881D_COMMAND_INSTR(0xA0,0x08),
	ILI9881D_COMMAND_INSTR(0xA1,0x11),
	ILI9881D_COMMAND_INSTR(0xA2,0x19),
	ILI9881D_COMMAND_INSTR(0xA3,0x0D),
	ILI9881D_COMMAND_INSTR(0xA4,0x0D),
	ILI9881D_COMMAND_INSTR(0xA5,0x1E),
	ILI9881D_COMMAND_INSTR(0xA6,0x14),
	ILI9881D_COMMAND_INSTR(0xA7,0x17),
	ILI9881D_COMMAND_INSTR(0xA8,0x4F),
	ILI9881D_COMMAND_INSTR(0xA9,0x1A),
	ILI9881D_COMMAND_INSTR(0xAA,0x27),
	ILI9881D_COMMAND_INSTR(0xAB,0x49),
	ILI9881D_COMMAND_INSTR(0xAC,0x1A),
	ILI9881D_COMMAND_INSTR(0xAD,0x18),
	ILI9881D_COMMAND_INSTR(0xAE,0x4C),
	ILI9881D_COMMAND_INSTR(0xAF,0x22),
	ILI9881D_COMMAND_INSTR(0xB0,0x27),
	ILI9881D_COMMAND_INSTR(0xB1,0x4B),
	ILI9881D_COMMAND_INSTR(0xB2,0x60),
	ILI9881D_COMMAND_INSTR(0xB3,0x39),
	ILI9881D_COMMAND_INSTR(0xC0,0x08),
	ILI9881D_COMMAND_INSTR(0xC1,0x11),
	ILI9881D_COMMAND_INSTR(0xC2,0x19),
	ILI9881D_COMMAND_INSTR(0xC3,0x0D),
	ILI9881D_COMMAND_INSTR(0xC4,0x0D),
	ILI9881D_COMMAND_INSTR(0xC5,0x1E),
	ILI9881D_COMMAND_INSTR(0xC6,0x14),
	ILI9881D_COMMAND_INSTR(0xC7,0x17),
	ILI9881D_COMMAND_INSTR(0xC8,0x4F),
	ILI9881D_COMMAND_INSTR(0xC9,0x1A),
	ILI9881D_COMMAND_INSTR(0xCA,0x27),
	ILI9881D_COMMAND_INSTR(0xCB,0x49),
	ILI9881D_COMMAND_INSTR(0xCC,0x1A),
	ILI9881D_COMMAND_INSTR(0xCD,0x18),
	ILI9881D_COMMAND_INSTR(0xCE,0x4C),
	ILI9881D_COMMAND_INSTR(0xCF,0x33),
	ILI9881D_COMMAND_INSTR(0xD0,0x27),
	ILI9881D_COMMAND_INSTR(0xD1,0x4B),
	ILI9881D_COMMAND_INSTR(0xD2,0x60),
...
static const struct ili9881d_panel_desc yb_tg7201280s03a_desc = {
	.init = yb_tg7201280s03a_init,
	.init_length = ARRAY_SIZE(yb_tg7201280s03a_init),
...
static const struct of_device_id ili9881d_of_match[] = {
	...
	{ .compatible = "surelink,yb_tg7201280s03a", .data = &yb_tg7201280s03a_desc },
	{ }
};
